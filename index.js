...
const UUID = process.env.UUID || 'ec332a46-9ac3-4e52-95f5-5b1ae1fd623c'; // UUID
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'ko.ooocc.dpdns.org';            // 固定隧道域名
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYTIyMGI2MDFlMmJlYWE0ODQzNWRkZjAyMjllYjg1YmUiLCJ0IjoiZWM1YTVkMjAtOTQyMi00MDdkLTkxNTctZTIyMjUxZmVlNWVlIiwicyI6Ik1tUmxNRFExTnpJdE1qSTBNaTAwWXpnd0xXRmpNRGd0TXpJeVpqSm1NVEV6WmpVMiJ9';                 // 固定隧道密钥
