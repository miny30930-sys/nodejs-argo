...
const UUID = process.env.UUID || '9e46e062-9ca0-434e-ae4c-c2760132b0db'; // UUID
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'ren.ooocc.dpdns.org';            // 固定隧道域名
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYTIyMGI2MDFlMmJlYWE0ODQzNWRkZjAyMjllYjg1YmUiLCJ0IjoiNTY0OTgzMTYtYjM1MS00ZGE1LTk0MDQtZTdlZTU5YWFmNjlkIiwicyI6Ik16SmpOREkxTVRJdFl6ZGlaUzAwTkdNM0xXSXhNMlV0TVRRM00yRmlOemswWmpGaCJ9';                 // 固定隧道密钥
